...
红黑树最早被称为对称二叉B树，从名字中可发现红黑树和B树（这里指的是`2-3-4`树）有一定的关联。前述树的篇章也有说明和图示，细节这里就不展开说明，有兴趣的可见[《算法》第4版](https://weread.qq.com/web/bookDetail/7cc32910718ff66b7cc8d9d)相关章节，已经说的很透彻了
